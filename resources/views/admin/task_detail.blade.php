...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="mb-3">
                <a href="{{route('admin.task')}}" class="btn btn-dark">
                        ...
                        <div class="co-md-12">
                            ...
                            <div class="card bg-light mb-3">
                                <div class="card-body">
                                    ...
                                    <hr>
                                    <form action="{{route('admin.user_and_status', $task->id)}}" method="post">
                                        @csrf()
                                        <div class="row">
                                            <div class="col-md-5">
            ...
            <div class="modal-content modal-filled bg-danger">
                <div class="modal-body p-4">
                    <div class="text-center text-white">
                        ...
                        <a href="{{route('admin.delete_task',$task->id)}}" class="btn btn-light my-2">Yes, Delete!</a>
                    </div>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
